    ...
    <div>
      ...
      {showForm ? (
        ...
        >
          ...
          <select
            ...
            value={form.category}
            onChange={(e) =>
              setForm({ ...form, category: e.target.value as OpportunityCategory })
            }
          >
            {categories.map((c) => (
          ...
          <label className="flex items-center gap-2 text-sm md:col-span-2">
            ...
            />
            Ongoing opportunity (no fixed deadline)
          </label>
          <Input
      ...
      {loading ? (
        ...
        <div className="bg-white rounded-xl shadow-sm divide-y">
          {items.map((o) => (
            <div key={o.id} className="p-4 flex justify-between items-start gap-4">
              <div>
              ...
              <Button
                ...
                onClick={() => void handleDelete(o.id, o.title)}
              >
